                        ...
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                if (inputemail.equals(emailemail) && inputpassword.equals(passwordpassword)) {
                                    ...
                                    Toast.makeText(b_Login.this, "로그인 정보가 올바르지 않습니다", Toast.LENGTH_SHORT).show();
                                }
                            ...
                            e.printStackTrace();
                            Toast.makeText(b_Login.this, "로그인 정보를 찾을 수 없습니다", Toast.LENGTH_SHORT).show();
                        }


                    } else { //사용자가 입력한 이메일이 회원 목록에 없을 때
                        Toast.makeText(b_Login.this, "이메일 정보가 없습니다", Toast.LENGTH_SHORT).show();
                    }

                } else {  // 사용자가 아무것도 입력하지 않았을 때
                    Toast.makeText(b_Login.this, "로그인 정보를 입력해주세요", Toast.LENGTH_SHORT).show();
                }
...
// 회원가입 버튼 -> 회원가입 화면으로 이동
        ...
        button_signUp.setOnClickListener(new ImageView.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(getApplicationContext(), b_Sign.class);
    ...
    protected void redirectSignupActivity() {
        final Intent intent = new Intent(this, b_Sign.class);
